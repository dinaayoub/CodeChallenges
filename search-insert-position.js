...
var searchInsert = function (nums, target) {
    ...
    /* Brute force way - for some bizarre reason this is registering as slower on leetcode, but for a large n it shouldn't be? I've tried n = 500 and brute force 's still faster!!
